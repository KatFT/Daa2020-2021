...
public class Daa038 {
    public static void main(String args[]) {
		...
		int a= ler.nextInt(); //casas ja na rede
		int b= ler.nextInt(); //casas a adicionar
		int c= ler.nextInt(); //possiveis novas ligaçoes

		Graph g = new Graph(c,a,b);

		for (int i=0; i<c; i++) 
		    g.addLink(ler.nextInt(), ler.nextInt(), ler.nextInt());
